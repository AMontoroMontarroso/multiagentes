...
public class Aeropuerto extends Agent {
    ...
    protected void setup(){
        ...
        //Filtrado para recibir solo mensajes del protocolo FIPA-Query.
    ...
    class ComprobarResponder extends AchieveREResponder{
        ...
        protected ACLMessage handleRequest(ACLMessage request) throws NotUnderstoodException, RefuseException{
            ...
            //Si el solicitante es valido se acepta su petición.
    ...
    protected ACLMessage prepareResultNotificaction(ACLMessage request, ACLMessage response) throws FailureException{
    ...
    //Metodo simple de aceptación o rechazo de solicitudes.
